  ...
  const onRequestPermissions = async() => {
    try {
      ...
      if( cameraPermissionStatus !== 'granted' ) {
        Alert.alert('No se otorgaron los permisos para la cámara')
        return;
      }
      ...
      if( mediaPermissionStatus !== 'granted' ) {
        Alert.alert('No se otorgaron los permisos para la galería')
        return;
      }
      ...
      console.log(error)
      Alert.alert('No se pudieron solicitar los permisos')
      return;
    }
  }
    ...
    return (
      <View style={{
        ...
        <Text style={styles.message}>
          Necesitamos los permisos para la cámara y la galería
        </Text>
        <TouchableOpacity
  ...
  if(selectedImage){
    return (
      <View style={styles.container}>
        ...
        <RetakeButton onPress={ onRetakePhoto } />
      </View>
    )
  }
